          ...
          <div className="flex items-center gap-3">
            <div className="relative group">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-2.5 text-sm bg-white text-slate-800 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none w-56 transition-shadow shadow-sm"
              />
            </div>
            <div className="relative group">
              ...
              <input 
                ...
                className="pl-10 pr-4 py-2.5 text-sm bg-white text-slate-800 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition-shadow shadow-sm"
              />
            </div>
            <motion.button 
              ...
              className="flex items-center gap-2 bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 px-4 py-2.5 rounded-lg text-sm font-bold transition-colors shadow-sm"
            >
            ...
            {loading ? (
              ...
              <AnimatePresence>
                {filteredLogs.map((log, index) => (
                  ...
                  >
                    <td className="px-8 py-4 text-sm text-slate-400 font-medium">#{log.id}</td>
                    <td className="px-8 py-4 text-sm font-bold text-slate-800">{log.name}</td>
                    <td className="px-8 py-4 text-sm text-slate-500 font-medium">{log.date}</td>
                    <td className="px-8 py-4 text-sm text-slate-600 font-mono">{log.time}</td>
